...
class ClassEnrollment(models.Model):
    """
    Used to create a relationship between students
    and classes
    """
...
class BookAssignments(models.Model):
    """
    Used to create a relationship between books and classes
    """
    related_class = models.ForeignKey("classes.Class", on_delete=models.CASCADE)
